...
const reasons = [
  ["01", "One company, multiple services", "Reduce the need to coordinate different contractors for routine outdoor property work."],
...
const WhyRoweSection = () => (
  <div className="grid overflow-hidden border border-(--border) bg-white lg:grid-cols-2">
    ...
    <div className="bg-[#111811] p-7 text-white sm:p-10 lg:p-14">
      ...
      <p className="mt-6 max-w-lg text-lg leading-8 text-white/65">Rowe All Around gives property owners one place to call for routine lawn maintenance, landscaping, trimming, and cleanup work.</p>
