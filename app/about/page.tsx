...
export const metadata: Metadata = {
  title: "About",
  description: "Learn how Rowe All Around brings lawn, landscaping, tree, cleanup, hauling, and property services together for Port Charlotte property owners.",
      ...
      <section className="grid bg-[#111811] text-white lg:grid-cols-2">
        <Container className="flex items-center py-14 lg:py-20">
          <div className="max-w-2xl lg:ml-auto lg:pr-12">
            ...
            <p className="mt-7 text-lg leading-8 text-white/68">Rowe All Around brings lawn and landscape care, tree services, storm cleanup, hauling, and other property services together for homes and properties in the Port Charlotte area.</p>
          </div>
        </Container>
